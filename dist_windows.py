...
for ts in coord.trajectory:
	...
	sel1.positions = wrapPositions(sel1.positions,sel1.numberOfAtoms(),box,r1)
	sel2.positions = wrapPositions(sel2.positions,sel2.numberOfAtoms(),box,r2)
	# compute new centers of mass 
	r1 = sel1.centerOfMass()
	r2 = sel2.centerOfMass()
	# compute distance
	dist = computePbcDist(r1,r2,box)
	...
	if dist_bin >=0 and dist_bin < n_dist_bins and dist_pop[dist_bin]==0:
		all_atoms.positions = wrapPositions(all_atoms.positions,all_atoms.numberOfAtoms(),box,r1)
		dist_pop[dist_bin]=1
		window = dist_bin+1
